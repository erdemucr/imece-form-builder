...
var Preview = function Preview(props) {
  ...
  var getElement = (0, _react.useCallback)(function (item, index) {
    ...
    if (!item || !item.element) {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        key: (item === null || item === void 0 ? void 0 : item.id) || "error-".concat(index)
    ...
    return /*#__PURE__*/_react["default"].createElement(SortableFormElement, {
      ...
      seq: seq.current,
      index: index,
      moveCard: function moveCard() {} // Bu fonksiyon tanımlı değil, boş bırakıldı
      ,
  ...
  }, [getDataById, insertCard, setAsChild, removeChild, _onDestroy, parent, editModeOn, registry]);
